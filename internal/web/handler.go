...
func (h *Handler) CreateProject(w http.ResponseWriter, r *http.Request) {
	...
	a, err := h.service.CreateProject(workflow.CreateInput{ProjectID: in.ProjectID, Title: in.Title, VenueZone: in.VenueZone, Width: in.SheetWidthMM, Height: in.SheetHeightMM, Gap: in.MinimumGapMM, Standard: in.BrailleStandard, Reviewer: in.ReviewerID, RequestID: in.RequestID})
	if err != nil {
		writeError(w, err)
		return
	}
